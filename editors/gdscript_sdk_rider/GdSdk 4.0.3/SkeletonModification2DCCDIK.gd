...
var ccdik_data_chain_length: int:
	get = get_ccdik_data_chain_length, set = set_ccdik_data_chain_length
...
var tip_nodepath: NodePath:
	get = get_tip_node, set = set_tip_node
...
func get_ccdik_data_chain_length() -> int:
	return ccdik_data_chain_length

func set_ccdik_data_chain_length(value: int) -> void:
	ccdik_data_chain_length = value
...
func set_tip_node(value: NodePath) -> void:
	tip_nodepath = value
