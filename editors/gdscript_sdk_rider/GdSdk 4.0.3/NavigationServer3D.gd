...
#desc Constant to get the number of active navigation maps.
#desc Constant to get the number of active navigation regions.
#desc Constant to get the number of active navigation agents processing avoidance.
#desc Constant to get the number of active navigation links.
#desc Constant to get the number of navigation mesh polygons.
#desc Constant to get the number of navigation mesh polygon edges.
#desc Constant to get the number of navigation mesh polygon edges that were merged due to edge key overlap.
#desc Constant to get the number of navigation mesh polygon edges that are considered connected by edge proximity.
#desc Constant to get the number of navigation mesh polygon edges that could not be merged but may be still connected by edge proximity or with links.
...
#desc Returns information about the current state of the NavigationServer. See [enum ProcessInfo] for a list of available states.
...
#desc Bakes the [param navigation_mesh] with bake source geometry collected starting from the [param root_node].
