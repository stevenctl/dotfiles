...
var up_vector_enabled: bool:
	get = is_up_vector_enabled, set = set_up_vector_enabled
...
func add_point(position: Vector3, in: Vector3 = Vector3(0, 0, 0), out: Vector3 = Vector3(0, 0, 0), index: int = -1) -> void:
	pass;
...
func is_up_vector_enabled() -> bool:
	return up_vector_enabled

func set_up_vector_enabled(value: bool) -> void:
	up_vector_enabled = value
