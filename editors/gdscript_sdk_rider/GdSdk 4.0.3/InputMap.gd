...
#tutorial [InputEvent: InputMap] https://docs.godotengine.org/en/stable/tutorials/inputs/inputevent.html#inputmap
class_name InputMap
...
func add_action(action: StringName, deadzone: float = 0.5) -> void:
	pass;
