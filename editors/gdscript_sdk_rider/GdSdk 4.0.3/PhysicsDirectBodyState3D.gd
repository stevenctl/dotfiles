...
#desc The inverse of the inertia tensor of the body.
...
#desc [b]Note:[/b] [member inverse_inertia] is required for this to work. To have [member inverse_inertia], an active [CollisionShape3D] must be a child of the node, or you can manually set [member inverse_inertia].
...
#desc Impulse created by the contact.
