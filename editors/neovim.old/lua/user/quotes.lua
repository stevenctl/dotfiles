...
local quotes = {
	...
	{ "Anonymous #167", 'The \'h\' in "software development" stands for "happiness".' },
	...
	{ "Anonymous #171", 'If you spell "Nothing" backwards, it becomes "Gnihton" which also means nothing.' },
